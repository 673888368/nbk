...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/673888368/nbk) 
...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示`Your app was successfully deployed` 
  ...
  * 默认协议密码为`https://www.uuidgenerator.net/`，路径为`/ray`
...
| UUID     | https://www.uuidgenerator.net/| [uuid在线生成器](https://www.uuidgenerator.net "uuid在线生成器") `务必替换`                       |
...
* 端口：443
* 默认UUID：https://www.uuidgenerator.net/
* vmess额外id：0
* 加密：auto
* 传输协议：ws
* 伪装类型：none
